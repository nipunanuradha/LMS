...
export default function LocationMap() {
  ...
  return (
    <section id="location" className="py-20 bg-slate-50 dark:bg-slate-950 relative border-t border-slate-200/70 dark:border-slate-800 transition-colors duration-200">
      {/* Background subtle glowing radial accents */}
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute top-1/3 -left-32 w-96 h-96 bg-blue-500/5 dark:bg-blue-500/10 rounded-full blur-3xl" />
        <div className="absolute bottom-10 right-0 w-96 h-96 bg-cyan-500/5 dark:bg-cyan-500/10 rounded-full blur-3xl" />
      </div>

      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        {/* Section Header */}
        <div className="text-center max-w-2xl mx-auto mb-14">
          <div className="inline-flex items-center gap-1.5 px-3.5 py-1 rounded-full bg-blue-100/80 dark:bg-blue-950/60 text-blue-700 dark:text-blue-300 text-xs font-semibold uppercase tracking-wider mb-3">
        ...
        {/* Card Container */}
        <div className="bg-white dark:bg-slate-900 rounded-3xl border border-slate-200 dark:border-slate-800 shadow-xl overflow-hidden grid lg:grid-cols-12">
          {/* Left Info Panel */}
          <div className="lg:col-span-5 p-8 sm:p-10 flex flex-col justify-between bg-gradient-to-b from-white to-slate-50/50 dark:from-slate-900 dark:to-slate-900/80">
            <div className="space-y-6">
              ...
              <div className="flex items-start gap-4 p-4 rounded-2xl bg-blue-50/70 dark:bg-blue-950/50 border border-blue-100 dark:border-blue-900/60 text-slate-800 dark:text-slate-200">
                <div className="p-3 bg-blue-600 dark:bg-blue-500 text-white rounded-xl shadow-sm shrink-0">
                  <MapPin className="w-5 h-5" />
                </div>
                <div>
                  <h4 className="font-bold text-sm text-slate-900 dark:text-white">Campus Address</h4>
                  <p className="text-sm text-slate-700 dark:text-slate-300 mt-0.5 leading-relaxed font-medium">
                    {address}
                  </p>
                </div>
              </div>
            ...
            <div className="pt-8 mt-6 border-t border-slate-100 dark:border-slate-800 flex flex-col sm:flex-row gap-3">
              <a
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className="inline-flex items-center justify-center gap-2 px-4 py-3 rounded-xl font-semibold text-sm bg-white dark:bg-slate-800 border border-slate-200 dark:border-slate-700 text-slate-700 dark:text-slate-200 hover:bg-slate-50 dark:hover:bg-slate-750 hover:border-slate-300 hover:text-blue-600 dark:hover:text-blue-400 transition-all cursor-pointer"
              >
                Open in Maps
          ...
          <div className="lg:col-span-7 h-[380px] sm:h-[450px] lg:h-auto min-h-[380px] relative bg-slate-100 dark:bg-slate-800">
            <iframe
              title="ICT Academy Location Map"
              src={embedUrl}
              className="w-full h-full border-0 absolute inset-0 dark:opacity-90 dark:contrast-110"
              allowFullScreen=""
              loading="lazy"
