          ...
          <tbody>
            {filtered.map((s,i) => (
              <tr key={s.id} className="table-row">
                ...
                <td style={{ padding:"13px 16px", fontSize:13, color:"#64748B", borderBottom:i<filtered.length-1?"1px solid #F8FAFC":"none" }}>{s.phone}</td>
                <td style={{ padding:"13px 16px", fontSize:13, color:"#64748B", borderBottom:i<filtered.length-1?"1px solid #F8FAFC":"none" }}>{s.district}</td>
                <td style={{ padding:"13px 16px", borderBottom:i<filtered.length-1?"1px solid #F8FAFC":"none" }}><StatusBadge status={s.status} /></td>
                <td style={{ padding:"13px 16px", fontSize:13, color:"#64748B", borderBottom:i<filtered.length-1?"1px solid #F8FAFC":"none" }}>{s.joined}</td>
                <td style={{ padding:"13px 16px", borderBottom:i<filtered.length-1?"1px solid #F8FAFC":"none" }}>
