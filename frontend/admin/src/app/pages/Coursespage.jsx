...
function CourseThumbnail({ course }) {
  ...
  return (
    <div style={{ width:"100%", aspectRatio:"16/9", borderRadius:"10px 10px 0 0", overflow:"hidden", background:course.accent, position:"relative", flexShrink:0 }}>
      <svg width="100%" height="100%" viewBox="0 0 240 135" preserveAspectRatio="xMidYMid slice">
        ...
        <text x="16" y="72" fontSize="28" fontWeight="700" fill="rgba(255,255,255,0.15)" fontFamily="DM Sans, sans-serif">{course.category}</text>
      </svg>
            ...
            <div style={{ padding:"16px 18px", flex:1, display:"flex", flexDirection:"column" }}>
              ...
              <div style={{ display:"flex", justifyContent:"space-between", alignItems:"center", marginTop:14, paddingTop:14, borderTop:"1.5px solid #F8FAFC" }}>
                <div style={{ display:"flex", alignItems:"center", gap:6, color:"#64748B", fontSize:13 }}>
                  <svg style={{width:15,height:15}} viewBox="0 0 24 24" fill="none" stroke={course.accent} strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/></svg>
                ...
                <div style={{ display:"flex", gap:6 }}>
                  ...
                  <button onClick={() => setCourses(prev=>prev.filter(c=>c.id!==course.id))} className="btn-danger"
