  ...
  return (
    <div style={{ animation:"fadeIn 0.25s ease", display:"flex", flexDirection:"column", gap:24 }}>
      ...
      <div style={{ display:"flex", gap:16 }}>
        <KPICard label="Total Students"    target={students.length} accent="#2563EB" icon={<svg style={{width:24,height:24}} viewBox="0 0 24 24" fill="none" stroke="#2563EB" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M17 21v-2a4 4 0 0 0-4-4H5a4 4 0 0 0-4 4v2"/><circle cx="9" cy="7" r="4"/><path d="M23 21v-2a4 4 0 0 0-3-3.87"/><path d="M16 3.13a4 4 0 0 1 0 7.75"/></svg>} />
      ...
      <div style={{ display:"grid", gridTemplateColumns:"1fr 340px", gap:20 }}>
        ...
        <div style={{ display:"flex", flexDirection:"column", gap:16 }}>
          ...
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12 }}>
            {[
              { label:"Active Students", val:active, color:"#DCFCE7", text:"#15803D" },
              { label:"Expired",         val:students.length-active, color:"#FEE2E2", text:"#B91C1C" },
              { label:"This Month",      val:3, color:"#DBEAFE", text:"#1D4ED8" },
              { label:"Avg. Per Course", val:Math.round(totalEnrollments/courses.length), color:"#EDE9FE", text:"#6D28D9" },
            ].map(card => (
